"""
PV and DER replacement script.

This script replaces existing PV units in the active EMTP design with the
standard CEN PV or DER template, preserving the original electrical connection,
